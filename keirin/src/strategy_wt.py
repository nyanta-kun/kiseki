...
def rank_7t1_is_target_race_type(race_type: str | None) -> bool:
    ...
    🔴 キーワードをここで定義せず、看板判定の正本
       （`backend/src/services/keirin_marquee.py`）を `marquee` 経由で使う。
       写した瞬間に「★は付くのに入稿されない」を作れる。
    """
