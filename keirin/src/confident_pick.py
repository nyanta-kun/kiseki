...
🔴 **`合成オッズ >= 3.0` のゲートは一撃商品を選びやすくする。** 当たりやすい帯
（合成 2.0〜2.5倍）を弾いて高配当側を残すので、旧規則（Σp 最大）とは**向きが逆**。
...
🟢 **これは仕様として維持する**（2026-09-12 ユーザー判断）。本規則は自信ありを
「当たりやすい1本」から**「大きく獲る1本」へ意図的に再定義**したものなので整合する。
