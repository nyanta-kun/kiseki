...
const TERMS = [
  {
    term: "単勝指数・複勝指数（2026-07-19導入）",
    def: "出走表に表示するAIモデルの予測確率。単勝指数=1着専用モデル(1着モデル)の予測確率、複勝指数=3着内モデルの予測確率をそれぞれ%表示。既存の「指数」列（競走得点）とは別軸の情報として単→複→指数の順に並べている。2024年以降の過去レースにも同じ四半期ウォークフォワードモデルで遡及反映済み。",
  },
  {
    term: "top3_gap",
