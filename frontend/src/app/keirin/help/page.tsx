...
const RANKS = [
  ...
  },
  {
    ...
    bg: "#7c3aed",
    label: "S3",
    title: "S3ランク（◎不一致×軸信頼／ペーパー検証中・2026-07-19 3way OR拡張）",
    subtitle: "7車 ｜ 三連複 2車軸流し ｜ 検証記録のみ・賭けなし",
    test: "154.3%",
...
const PROTOCOL_RESULTS = [
  { month: "検証 2025-04〜2026-03", s2: "127.8%（320R）", s3: "158.6%（671R）" },
  { month: "テスト 2026-04〜07-15", s2: "117.1%（87R・的中14.9%）", s3: "154.3%（186R・目≥15限定）" },
];
      ...
      <section className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 pt-1">
          ...
          <div className="bg-gray-50 rounded-lg p-2.5 text-center">
            ...
            <p className="text-xs text-gray-400">186R ・ 目≥15限定（検証1年 158.6%）</p>
          </div>
        </div>
