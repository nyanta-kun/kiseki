...
const RANKS = [
  {
    ...
    bg: "#a16207",
    label: "SS+",
    title: "SS+ランク（SS内、軸2車の級班に各グレード最上位(S1級/A1級)を含まない観察用サブランク／ペーパー検証中・2026-07-23導入）",
    subtitle: "7車 ｜ 三連複 2軸総流し(5点) ｜ 検証記録のみ・賭けなし ｜ SSの内訳（買い目・投資額はSSと同一）",
    test: "362.1%",
    ...
    investment: "ペーパートレード（名目 100円/点・5点/レース・SSの内訳のため合算には含めない）",
  },
  {
    key: "SS",
    bg: "#ca8a04",
  ...
  },
  {
    ...
    investment: "ペーパートレード（名目 100円/点・約6.9R/日）",
  },
];
