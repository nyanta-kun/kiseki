...
const RANKS = [
  ...
  },
  {
    ...
    detail:
      "「1着になるか」だけを学習した専用モデルで軸を固定し、3着内モデルで相手2車を選ぶ新設計。閾値は当初0.15で採用したが、母数を1日15R程度に絞り的中率を上げたいという要望を受け同日中に0.22へ引き上げ（0.08〜0.20の単調改善帯の自然な延長）。的中率16.7%→18.1%・母数は約半分に減少。SS/Sとの重複はわずかとほぼ独立。",
