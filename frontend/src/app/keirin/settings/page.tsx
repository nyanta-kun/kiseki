...
const TYPE_LAB_LABEL: Record<TypeLabRankKey, string> = {
  ...
  // 🔴 2026-09-06（PR#476）に 9車の決勝以外は `F_hit` から `F_line` へ置き換えた。
  //    `F_hit` は過去分の絞り込み用に残す。
  F_line: "型F 大混戦・9車の決勝以外（三連複・最強ラインの2車軸＋相手流し・計画払戻2万円まで）",
  ...
  //    `HIGHPAY_TYPES`（既定 B/C/D）だけ**で、日次上限で捨てるレースに置く。
  //    `_sign` と同じ理由で6型ぶん並べてある。
  A_big: "型A 高額枠・特大狙い（三連単・軸1を買わず、当たれば40万円を狙うダッチ・「穴狙い」付与）",
  B_big: "型B 高額枠・特大狙い（三連単・軸1を買わず、当たれば40万円を狙うダッチ・「穴狙い」付与）",
  C_big: "型C 高額枠・特大狙い（三連単・軸1を買わず、当たれば40万円を狙うダッチ・「穴狙い」付与）",
