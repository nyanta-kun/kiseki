...
const SECTIONS: Array<{
...
}> = [
  {
    ...
    // 条件は Phase2(2026-06-05)のランキング規則。EV ゲートは廃止済み。
    // walk-forward の honest 検証では該当がほぼ消え、黒字の裏づけは取れていない。
    note: "指数1位 ∧ 単勝10〜30倍 ∧ 割安5場（浦和/金沢/高知/笠松/盛岡）。honest 検証では黒字の裏づけなし（予想の参考）",
  },
  {
    key: "place_bet",
    title: "◆ 複穴（断然人気R × 高オッズ複勝買い）",
    titleClass: "text-blue-700",
    // 数値は前向き記録 chihou.place_picks の実測（採点済 572R / 2026-08-14〜09-01）。
    // 241点 複勝的中 36.93% CI95[31.09,43.18] / 複勝ROI 0.773 CI95[0.619,0.951]。
    note: "1番人気 単勝<2.0 ∧ 単勝≥10 ∧ 指数3位内 ∧ 8頭立て以上。前向き記録の実測 複勝的中 36.9%（同条件の母集団 17.8% の約2.1倍）/ 複勝ROI 0.77（控除率分マイナス・予想の参考）",
  },
  {
    key: "upset_place",
    title: "🎯 穴軸複勝（人気薄リランカー）",
