                        ...
                        <div className="flex items-center gap-1 flex-wrap">
                          ...
                          */}
                          ...
                          {/*
                            ...
                            発走約10分前のスナップショットが撮れるまでは最新オッズでの「候補」で、
                            点線枠で区別する。撮れた時点で「確定」（塗り）に変わる。
                          */}
                          {horse.is_place_pick && (
                            <span
                              className={cn(
                              ...
                              title={
                                (horse.place_pick_source === "snapshot"
                                  ? "複勝ピック【確定】発走約10分前のオッズで確定。"
                                  : "複勝ピック【候補】最新オッズで判定。発走約10分前に確定し、オッズ次第で外れることがある。")
                                + "条件: 8頭以上 ∧ 複勝3.0〜4.0倍未満 ∧ 複勝確率5位以内 ∧ 単勝÷複勝≤3.5。"
                              }
                            >
                              {horse.place_pick_source === "snapshot" ? "複勝" : "複勝候補"}
                            </span>
                          )}
                          {isAnagusa && (
                            <span className={cn(
