...
logistic 回帰で人気薄を並べ替え、帯[10,15)×スコア上位1/3×バッジで抽出する。

検証 (memory: upset_place_extraction.md, 2026-06-11):
  - 2026 純フォワード精度 35.3% (帯base 27.0% / 全人気薄base 10.5%)
  - 発走前オッズ(-10分)判定でも 34.8% — 実運用入力で成立
  - A2(バッジ>=1) 約8頭/日・A3(バッジ>=2) 約3頭/日
