...
SIGNAL_HEIHACHI (平八、2026-09-06追加 [[jra_heihachi_badge]]):
  ...
  honest 期間（2025-07-01〜2026-09-06 = v28 の学習終端より後）の実測:
    n=35  3着内率 **42.9%**（同期間の全出走馬ベース 21.7%）
    ⚠️ 単勝ROI 2.46 / 複勝ROI 1.53 という数字も出るが、**n=35 の点推定で、
       内訳は 25H2 n=13 複1.73 / 26H1 n=13 複2.25 / 26Q3 n=9 複0.19**。
       回収率は主張しない。ROI を見るなら推奨ページの年間バックテスト欄で
       n と年を確認すること。
