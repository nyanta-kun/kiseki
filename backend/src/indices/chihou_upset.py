...
検証 (memory: upset_place_extraction.md 地方編, 2026-06-11・train/val/test 3分割で再実施):
  - test(2026-01〜06, 凍結1回評価): A2 精度 37.5% CI[0.352,0.399]
    (帯base 31.8%・市場同数 34.2%)
  - ウォークフォワード3fold: 34.8/35.1/37.1% — 全foldで base・市場同数を上回り安定
  - 発走前オッズ(-10分)判定: 30.7% vs 市場同数 23.3%
    = 締切前の市場が織り込む前の時間帯にこそエッジ (+7pt)
