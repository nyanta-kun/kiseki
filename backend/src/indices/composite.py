...
# v18: 穴馬激走条件ボーナス追加 (2026-04-17)
#   バックテスト（16,198R 2023-2026）実証に基づく2指数の改良:
#   ① career_phase（成長曲線指数）: 昇級2〜3戦目クラス慣れボーナス追加
#      prize_1st しきい値でクラス判定（70K/110K/145K/190K百円）
#      昇級2戦目 +6.0pt (ROI差 +15.1%), 昇級3戦目 +4.0pt (ROI差 +12.2%)
