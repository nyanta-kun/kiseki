...
COURSE_NAMES: dict[str, str] = {
    ...
    "46": "金沢",       # NAR公式コード46=金沢（荒尾は56、2011年廃止）
    "47": "笠松",
    ...
    "54": "高知",       # 足摺盃・室戸盃より確定
    "55": "佐賀",       # 佐賀記念Jpn3より確定
    "56": "荒尾(廃止)", # NAR公式コード56=荒尾（2011年廃止）・霧島賞等
    "57": "廃止場(57)",
    "58": "廃止場(58)",
    "59": "廃止場(59)",
...
def parse_tk(data: str) -> list[dict[str, Any]]:
    ...
    """
    if len(data) < _TK_HORSE_SECTION_START + _TK_ENTRY_SIZE:
        logger.warning(f"TK record too short: {len(data)} chars")
        return []
