...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("course_name", sa.String(20), nullable=False, comment="競馬場名"),
        sa.Column(
            "direction", sa.SmallInteger, nullable=False, comment="回り方向: 1=左回り, -1=右回り"
        ),
        sa.Column("straight_distance", sa.Numeric(6, 1), nullable=False, comment="最終直線距離(m)"),
        sa.Column("elevation_diff", sa.Numeric(4, 2), nullable=False, comment="最終直線高低差(m)"),
        sa.Column("circuit_length", sa.Integer, nullable=False, comment="芝コース1周距離(m)"),
        sa.Column("grass_type", sa.String(20), nullable=False, comment="芝種別: 洋芝 / 野芝+洋芝"),
