...
- 2026-09-06 `TEST_START=20260701` **scripts/jra_darkhorse_walkforward.py --eval-start 20250101 --eval-end 20260930**: 人気薄帯の識別力の天井測定（継続課題4の feasibility・採否判断ではなく現状測定） — 2026Q3 を7四半期のうち1つとして使用。walk-forward（四半期ごとに vintage モデルを学習）なので モデル側の look-ahead は無い。結論は「人気を揃えた正味リフトは 9番人気以下でCIが0を跨ぐ／市場乖離ルールの複勝ROIは0.79で頭打ち」で、2026Q3 を除いても変わらない（四半期別内訳あり）。結果は docs/jra_darkhorse_ceiling_2026_09_06.md。継続課題4（残差モデル）は着手しないと判断した。
